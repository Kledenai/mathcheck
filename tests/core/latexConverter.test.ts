...
describe("convertToLatex", () => {
  it("should convert a valid mathematical expression to LaTeX", () => {
    const result = convertToLatex("(2 + 3) * 5");
